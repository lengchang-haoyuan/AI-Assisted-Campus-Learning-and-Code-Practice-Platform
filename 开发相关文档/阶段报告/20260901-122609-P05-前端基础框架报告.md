...
- `PRODUCT.md`、`开发相关文档/界面设计/界面设计说明.md`、`.impeccable/design.json`、`开发相关文档/界面设计/界面设计验收记录.md`：产品边界、实际设计令牌和视觉验收记录。
...
- Impeccable HERO 严格像素门为 55%，未达到 72% 阈值并保持 open。参考图包含社区动态、学习统计、多人协作和 Workflow 模板，而这些属于 P06/P07/P09；当前阶段选择真实数据边界，不用虚构模块换取像素匹配。详细证据见 `开发相关文档/界面设计/界面设计验收记录.md`。
