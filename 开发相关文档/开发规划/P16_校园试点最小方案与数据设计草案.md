...
D1–D4 已由用户于 2026-09-05 确认并授权实施 P17；D5 由用户于 2026-09-07 确认采用推荐的独立班级/任务、发布冻结和白名单项目快照方案并授权实施 P18。以上确认只覆盖技术设计和隔离开发验收；D6–D9、真实人员、真实账号初始化、教师教学确认和校方批准仍待确认。
...
- [x] 用户逐项确认 D1–D5，确认 P17 身份边界与 P18 独立班级、成员、任务、发布冻结和项目快照方案。
...
确认层级记录：设计草案已完成；用户已于 2026-09-05 确认 D1–D4 技术方案并授权隔离实施 P17，于 2026-09-07 确认 D5 并授权实施 P18。教师教学确认、校方批准试点、真实首管理员指定及真实成员导入均未取得；代码完成、本地迁移或 Git 状态都不改变这些外部状态。
